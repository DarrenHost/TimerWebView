...
|---------|--------------|----------|------|
| **v1.6** | 2026-06-21 | [📱 TimerWebView-v1.6-release.apk](https://github.com/DarrenHost/TimerWebView/releases/download/v1.6/TimerWebView-v1.6-release.apk) | 9.3 MB |

**Direct Download Links:**
- **GitHub Release**: https://github.com/DarrenHost/TimerWebView/releases/download/v1.6/TimerWebView-v1.6-release.apk
- **GitHub Assets**: https://github.com/DarrenHost/TimerWebView/blob/master/Assets/TimerWebView-v1.6-release.apk
- **NAS (Local)**: `/data/gswy/00_临时文件/TimerWebView-v1.6-release.apk`
